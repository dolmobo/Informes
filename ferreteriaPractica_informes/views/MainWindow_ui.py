...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if (self.tableCarne.columnCount() < 4):
            self.tableCarne.setColumnCount(4)
        ...
        self.tableCarne.setHorizontalHeaderItem(3, __qtablewidgetitem3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblTitulo.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:700;\">GESTION DE HORAS</span></p></body></html>", None))
        ...
        ___qtablewidgetitem3 = self.tableCarne.horizontalHeaderItem(3)
