...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(736, 570)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(0, 10, 731, 501))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblTitulo.setText(QCoreApplication.translate("MainWindow", u"LBLTITULO", None))
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Puntos", None));
